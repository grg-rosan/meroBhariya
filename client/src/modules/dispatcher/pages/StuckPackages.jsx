        ...
        {packages.map((pkg) => {
          ...
          return (
            <div
              ...
              className={`bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 border-l-4 ${pkg.hoursInHub >= 36 ? "border-l-red-500" : "border-l-amber-500"}`}
            >
              <div className="flex items-start gap-4">
                {/* Time badge */}
                <div
                  className={`shrink-0 px-3 py-2 rounded-lg text-center ${c.bg}`}
                >
