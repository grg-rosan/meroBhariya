...
export default function StaffRow({ member, onToggle, isToggling }) {
  ...
  return (
    <div className="flex items-center gap-4 px-4 py-3.5 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl hover:border-zinc-300 dark:border-zinc-700 transition-colors">
      {/* avatar */}
      <div
      ...
      <button
        ...
        disabled={isToggling}
        className="shrink-0 p-1.5 rounded-lg hover:bg-zinc-100 dark:bg-blue-950 text-zinc-300  hover:text-zinc-700 dark:text-zinc-300 transition-all disabled:opacity-40"
