...
export default function DocReviewPanel({ doc, onReview, loading }) {
  ...
  return (
    <div className="mb-3 p-3 bg-zinc-100 dark:bg-blue-950 rounded-lg border border-zinc-300 dark:border-zinc-700">
      <a
        href={doc.fileUrl}
        target="_blank"
        rel="noreferrer"
      ...
      <input
        ...
        className="w-full px-3 py-2 text-xs bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded-lg text-zinc-800 dark:text-zinc-200 placeholder-zinc-400 dark:placeholder-zinc-600 focus:outline-none focus:border-violet-500 mb-2"
      />
