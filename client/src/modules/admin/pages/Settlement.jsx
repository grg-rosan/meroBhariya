        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-zinc-800">
              ...
              {["Rider", "Vehicle", "COD held", "Shipments", "Action"].map(
                (h) => (
                  <th
                    key={h}
          ...
          <tbody>
            {loading ? (
              ...
              riders.map((r) => (
                <tr
                  key={r.id}
                  className={`border-b border-zinc-800/50 hover:bg-gray-100 dark:bg-blue-950/20 transition-colors ${selected.has(r.id) ? "bg-violet-500/5" : ""}`}
                >
