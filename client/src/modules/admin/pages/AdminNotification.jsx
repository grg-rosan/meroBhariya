    ...
    <div className="p-6 max-w-2xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        {unreadCount > 0 && (
          <button
            onClick={markAllRead}
            className="flex items-center gap-1.5 text-xs text-gray-500 dark:text-zinc-400 hover:text-white border border-gray-300 dark:border-zinc-700 hover:border-gray-500 dark:hover:border-zinc-500 px-3 py-1.5 rounded-lg transition-all"
          >
      ...
      {notifications.length === 0 ? (
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-zinc-800 rounded-xl p-12 text-center">
          <Bell
            size={32}
            className="text-gray-200 dark:text-zinc-700 mx-auto mb-3"
          />
          <p className="text-gray-300 dark:text-zinc-600 text-sm">
