...
export function GpsStatus({ loc, loading }) {
  return (
    ...
    >
      <div
        className={`w-8 h-8 rounded-lg flex items-center justify-center ${loc ? "bg-green-500/10" : "bg-zinc-100 dark:bg-blue-950"}`}
      >
        <Navigation2
          size={15}
          className={
            loc ? "text-green-400" : "text-zinc-400 dark:text-zinc-500"
          }
        />
      </div>
