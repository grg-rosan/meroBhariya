...
export function DeliveryForm({
  ...
  return (
    <div className="bg-white dark:bg-gray-900 border border-zinc-800 rounded-xl p-5 space-y-4 mb-4">
      <div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2.5 text-sm bg-gray-100 dark:bg-blue-950 border border-zinc-700 focus:border-zinc-500 rounded-lg text-zinc-200 placeholder-zinc-600 focus:outline-none transition-colors"
        />
      </div>
    </div>
  );
