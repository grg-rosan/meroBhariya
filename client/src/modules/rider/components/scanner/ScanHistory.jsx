function ScanHistoryRow({ trackingNumber, action, time, cod }) {
  return (
    <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-200/50 dark:border-zinc-800/50 last:border-none hover:bg-zinc-100 dark:hover:bg-blue-950/30">
      <span className="font-mono text-xs text-zinc-500 dark:text-zinc-400">{trackingNumber}</span>
