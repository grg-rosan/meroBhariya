...
export default function RiderScanner() {
  ...
  return (
    <div className="p-6 max-w-xl mx-auto">
      ...
      {/* Mode toggle */}
      <div className="flex items-center gap-1 bg-white dark:bg-gray-900 border border-zinc-800 rounded-lg p-1 mb-4 w-fit">
      ...
      {/* Scan box */}
      <div
        className={`border-2 border-dashed rounded-xl p-8 text-center mb-4 ${scanResult ? "border-green-600 bg-green-500/5" : "border-zinc-700 bg-white dark:bg-gray-900"}`}
      >
        ...
        <div className="flex gap-2 justify-center">
          <input
            ...
            className="w-40 px-3 py-2 text-sm bg-gray-100 dark:bg-blue-950 border border-zinc-700 rounded-lg text-zinc-200 placeholder-zinc-600 focus:outline-none focus:border-sky-500"
          />
          <button
            onClick={handleScan}
      ...
      {scanResult && !success && (
        <div className="bg-white dark:bg-gray-900 border border-zinc-800 rounded-xl p-4 mb-4">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs text-zinc-400 mb-4">
            ...
            <div>
              <span className="text-zinc-600">COD: </span>
            ...
            <div className="border-t border-zinc-800 pt-3 space-y-3">
              <div>
                ...
                <input
                  ...
                  placeholder="0"
                  className="w-full px-3 py-2 text-sm bg-gray-100 dark:bg-blue-950 border border-zinc-700 rounded-lg text-zinc-200 focus:outline-none focus:border-sky-500"
                />
              </div>
              <div>
                <label className="text-xs text-zinc-500 block mb-1">
      ...
      <div className="bg-white dark:bg-gray-900 border border-zinc-800 rounded-xl overflow-hidden">
        ...
        {SCAN_HISTORY.map((h) => (
          <div
            key={h.id}
            className="flex items-center justify-between px-4 py-3 border-b border-zinc-800/50 last:border-none hover:bg-gray-100 dark:bg-blue-950/30"
          >
