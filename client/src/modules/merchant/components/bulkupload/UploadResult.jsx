  ...
  return (
    <div className="bg-white dark:bg-gray-900 border border-green-700/50 rounded-xl p-4 mb-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-sm font-medium text-gray-800 dark:text-zinc-200">Upload complete</span>
      </div>
      <div className="grid grid-cols-3 gap-3 text-center">
        <div>
          <div className="text-xl font-semibold text-white">{result.total}</div>
          <div className="text-xs text-gray-400 dark:text-zinc-500 mt-0.5">Total rows</div>
        </div>
        <div>
          <div className="text-xl font-semibold text-green-400">{result.processed}</div>
          <div className="text-xs text-gray-400 dark:text-zinc-500 mt-0.5">Processed</div>
        </div>
        <div>
          <div className="text-xl font-semibold text-rose-400">{result.errors}</div>
          <div className="text-xs text-gray-400 dark:text-zinc-500 mt-0.5">Errors</div>
        </div>
      </div>
    </div>
  );
...
function ErrorBanner({ error }) {
  return (
    <div className="bg-white dark:bg-gray-900 border border-red-700/50 rounded-xl p-4 mb-4 flex items-center gap-2">
