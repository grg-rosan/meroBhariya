      ...
      <table className="w-full text-sm">
        ...
        <tbody>
          {HISTORY.map((h) => (
            ...
            >
              <td className="px-4 py-3 text-xs text-gray-500 dark:text-zinc-400">{h.date}</td>
              <td className="px-4 py-3 text-xs font-mono text-gray-700 dark:text-zinc-300">{h.filename}</td>
              <td className="px-4 py-3 text-xs text-gray-500 dark:text-zinc-400">{h.total}</td>
