            ...
            <tbody>
              {shipments.map((s) => (
                <tr
                  ...
                  className={
                    "border-b border-zinc-800/50 hover:bg-gray-100 dark:bg-blue-950/30 transition-colors " +
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <button className="flex items-center gap-1.5 px-2.5 py-1 text-xs border border-zinc-700 text-zinc-400 hover:text-zinc-200 hover:bg-gray-100 dark:bg-blue-950 rounded transition-all">
