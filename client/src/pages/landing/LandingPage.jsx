      ...
      <section className="pt-32 pb-24 px-6 max-w-6xl mx-auto">
        <div className="max-w-3xl">
          ...
          <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-800 text-xs font-semibold px-3 py-1.5 rounded-full mb-6 tracking-wide uppercase">
            ...
            Nepal's trusted delivery partner
          </div>
          ...
          {[
            {
              ...
              benefit:
                "So what? You never lose money on a damaged or lost package. File a claim and get reimbursed — no arguments.",
            ...
            },
            {
              ...
              benefit:
                "So what? No more 'where is my package?' calls. Your customers stay informed automatically.",
            ...
            {[
              {
                ...
                desc: "Enter pickup and delivery details from your merchant dashboard. We calculate fare instantly.",
              },
              {
                step: "02",
                title: "We pick it up",
                desc: "A verified rider arrives at your location within the committed window. Package is scanned and insured on pickup.",
              },
              {
                step: "03",
                title: "Delivered & confirmed",
                desc: "Customer receives the package. You get a delivery confirmation with proof. COD settled directly.",
              },
            ].map((s) => (
              <div
                key={s.step}
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            {
              quote:
                "We switched from three different couriers to just meroBhariya. Our delivery complaints dropped to zero.",
              name: "Sanjay Maharjan",
              biz: "New Road Electronics, Kathmandu"
            },
            {
              quote:
                "The insurance alone made it worth it. One damaged item claim was settled within 24 hours.",
              name: "Priya Shrestha",
              biz: "Thamel Organic Store",
            },
            {
              quote:
                "Our riders are always on time. The dispatcher dashboard is clean and we can track everything live.",
              name: "Bikram Rai",
          ...
          <div className="flex flex-col divide-y divide-zinc-100">
            {[
              ...
              },
              {
                ...
                a: "We currently operate across the Nepal Valley — Nepal, Lalitpur, and Bhaktapur. Expansion to other cities is planned for 2025.",
              },
            ].map((f) => (
              <details
                key={f.q}
      ...
      <section className="bg-blue-800 py-24 px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-blue-200 mb-10 leading-relaxed">
            Join 500+ Nepal businesses who trust meroBhariya with their
            deliveries. No setup fees. No contracts. Cancel anytime.
          </p>
...
<div className="flex items-center gap-3">
  <img
    src="/logo4.png"
    alt="MeroBhariya"
    className="h-24 w-auto object-contain mix-blend-screen brightness-150 saturate-200 -my-6"
  />
