    ...
    <div className="relative" ref={menuRef}>
        ...
        <div className="absolute bottom-full left-0 right-0 mb-2 bg-white dark:bg-white dark:bg-gray-900 border border-gray-200 dark:border-zinc-800 rounded-xl shadow-2xl p-2 z-50 overflow-hidden">
          ...
          <div className="flex items-center gap-3 p-3 border-b border-gray-100 dark:border-gray-200/50 dark:border-zinc-800/50 mb-1">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] text-gray-400 dark:text-gray-400 dark:text-zinc-500 uppercase tracking-widest">
                {role}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-0.5">
            ...
            <button
              onClick={toggle}
              className="flex items-center gap-3 w-full px-3 py-2 text-xs text-gray-500 dark:text-gray-500 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-100 dark:bg-blue-950 rounded-lg transition-all"
            >
              {dark ? (
                <>
      ...
      <div
        ...
        className={`flex items-center gap-3 p-2 rounded-xl cursor-pointer transition-all
          ...
          ${isOpen ? "bg-gray-100 dark:bg-gray-100 dark:bg-blue-950 border-gray-200 dark:border-gray-300 dark:border-zinc-700" : ""}`}
      >
        <div
        ...
        <div className="min-w-0 flex-1">
          <p className="text-xs text-gray-700 dark:text-gray-700 dark:text-zinc-300 font-medium truncate">
            {user?.name ?? "User"}
          </p>
          <p className="text-[10px] text-gray-400 dark:text-gray-400 dark:text-zinc-500 truncate">
            {role.toLowerCase()}
          </p>
        </div>
        <ChevronUp
          size={14}
          className={`text-gray-400 dark:text-gray-300 dark:text-zinc-600 transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`}
        />
      </div>
    </div>
  );
