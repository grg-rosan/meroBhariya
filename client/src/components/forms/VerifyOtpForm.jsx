...
export default function VerifyOtpForm({ email, onVerify, onResend }) {
  ...
  // Reset the ref when digits are cleared (e.g. on error)
  useEffect(() => {
                  ...
                  {digits.map((d, i) => (
                    <input
                      ...
                      className={`
                        ...
                        bg-zinc-100 dark:bg-blue-950 border rounded-xl text-white outline-none
                ...
                <p className="text-xs text-zinc-400 dark:text-zinc-500">
                  ...
                  {resendCooldown > 0 ? (
                    ...
                    <button
                      ...
                      className="text-zinc-500 dark:text-zinc-400 hover:text-white transition-colors underline underline-offset-2"
                    >
                      Resend code
                    </button>
                  )}
