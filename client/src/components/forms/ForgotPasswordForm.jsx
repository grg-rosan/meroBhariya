...
export default function ForgotPasswordForm({ onSubmit }) {
  ...
  return (
    // ✅ Light default, dark variant for dark mode
          ...
          {sent ? (
            <div className="text-center py-4">
              ...
              <button
                ...
                className="mt-6 text-xs text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors underline underline-offset-2"
              >
              ...
              <div className="mb-5">
                ...
                <div className="relative">
                  <input
                    ...
                    autoFocus
                    className={`
                      w-full bg-zinc-100 dark:bg-zinc-800 border rounded-xl px-4 py-3 text-sm
