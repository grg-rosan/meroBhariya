              ...
              <div className="mb-5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-zinc-100 dark:bg-blue-950 border border-zinc-300 dark:border-zinc-700 rounded-xl px-4 py-3 pr-11 text-sm text-white placeholder:text-zinc-300 dark:text-zinc-600 outline-none transition-all duration-200 focus:border-zinc-500 focus:ring-2 focus:ring-zinc-500/20"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPw((v) => !v)}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-400  hover:text-zinc-700 dark:text-zinc-300 transition-colors"
                  >
                    <EyeIcon open={showPw} />
                  </button>
                </div>
                ...
                {password.length > 0 && (
                  <>
                      ...
                      {[0, 1, 2, 3].map((i) => (
                        <div
                          ...
                          className={`flex-1 h-0.5 rounded-full transition-all duration-300 ${
                            i < strength
                              ? strengthConfig[strength].cls
                              : "bg-zinc-200 dark:bg-blue-900"
                          }`}
                        />
                      ))}
                    </div>
                    <p
                      ...
                      style={{
                        color: strengthConfig[strength]?.color ?? "#71717a",
                      }}
                    >
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full bg-zinc-100 dark:bg-blue-950 border rounded-xl px-4 py-3 pr-11 text-sm text-white placeholder:text-zinc-300 dark:text-zinc-600 outline-none transition-all duration-200 focus:ring-2 focus:ring-offset-0 ${
                      mismatch
