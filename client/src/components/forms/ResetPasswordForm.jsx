...
export default function ResetPasswordForm({ onSubmit }) {
  ...
  const inputBase =
    "w-full bg-zinc-100 dark:bg-zinc-800 border rounded-xl px-4 py-3 pr-11 text-sm " +
    "text-zinc-900 dark:text-white placeholder:text-zinc-400 dark:placeholder:text-zinc-500 " +
    "outline-none transition-all duration-200 focus:ring-2 focus:ring-offset-0";
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 sm:p-8 shadow-sm">
          {success ? (
            <div className="text-center py-4">
              ...
              <p className="text-zinc-900 dark:text-white font-medium">Password updated!</p>
              ...
              <div className="mb-5">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`${inputBase} border-zinc-300 dark:border-zinc-700 focus:border-zinc-500 focus:ring-zinc-500/20`}
                  />
