              ...
              <div className="mb-5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-gray-100 dark:bg-blue-950 border border-zinc-700 rounded-xl px-4 py-3 pr-11 text-sm text-white placeholder:text-zinc-600 outline-none transition-all duration-200 focus:border-zinc-500 focus:ring-2 focus:ring-zinc-500/20"
                  />
                  <button
                    type="button"
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full bg-gray-100 dark:bg-blue-950 border rounded-xl px-4 py-3 pr-11 text-sm text-white placeholder:text-zinc-600 outline-none transition-all duration-200 focus:ring-2 focus:ring-offset-0 ${
                      mismatch
